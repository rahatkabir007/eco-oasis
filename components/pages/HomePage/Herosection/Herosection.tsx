            ...
            <div className={`block md:flex justify-between items-start py-20 px-10 md:px-28 md:py-24 gap-[150px] ${css["bg"]}`}>
                <div className="container-x flex flex-col gap-y-36 md:gap-y-60">
                    <div className="w-full md:w-1/2 ">
                        <p className="text-herogreen text-[24px] md:text-[49px] dark:text-white"> <span className='font-semibold'>Bangladesh:</span>
                            <br />The Land of<br />
                            <span className='font-semibold'>Business Opportunities</span></p>
                    </div>
                    <div className='mt-32 md:mt-0'>
                        <div className="">
                            <p className="text-herogreen font-bold text-[24px] md:text-[49px]">Eco Oasis Limited</p>
                        </div>
                        <div className="">
