...
export class Jsondata {
    ...
    static aboutData = [
        ...
        },
        {
            ...
            description: `To implant sustainable positioning aiming to originate distinct trend in the changing global market through positive reinforcement and value proposition.`,
            height: '385px',
            padding: "3rem 2.2rem"
        },
        {
